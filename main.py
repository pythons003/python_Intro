...
# # # class Student:
# # #     def __init__(self,Name="deafult",age=18,grade=1, city='riyadh',speacialise = 'computer',password='123456'):
# # #         self.name = Name
# # #         self.age = age
# # #         self.grade = grade
# # #         self.city = city
...
# # #                     # print(student)
# # #                     # add the user choice to add new course,take quiz,show my courses,show the greads and exit
# # #                     # add pass verfication
# # #                     print('1- add new course')
# # #                     print('2- take quiz')
# # #                     studentChoice = int(input('enter your choice:'))
# # #                     if studentChoice ==1:
# # #                         student.addCorse(input('enter the course name:'))
...
# # #         password = input('enter your password:')
# # #         student1 = Student(name, age, grade, city, speacialise, password)
...
# # #  defrent betweet public and private

# # #  public : is the variable or the method that you can access it from any where
# # #  private : is the variable or the method that you can access it from inside the class only
...
# # # student1 = Student('mohammed', 30, 1, 'riyadh', 'computer', '123456')
# # # print(student1.changePassword('123456789'))
# # # print(student1.getPassword())


# # #  creat a class for products in market
# # #  Att: Name ,originPrice,SellingPrice,ExpireDate

# # # class Products:
# # #     def __init__(self,Name,originPrice,SellingPercantage,ExpireDate):
# # #         self.name = Name
# # #         self.__originPrice = originPrice
# # #         self.SellingPercantage = SellingPercantage
# # #         self.ExpireDate = ExpireDate


# # #     def __str__(self):
# # #         return f'name is {self.name} and Sell Price is {self.getSellPrice()}  and ExpireDate is {self.ExpireDate}'

# # #     def getSellPrice(self):
# # #         sellPrice= self.__originPrice + (self.__originPrice * self.SellingPercantage )
# # #         return sellPrice

# # # product1 =Products('milk', 10, 0.1, '1/1/2024')
# # # print(product1)
...
# # # Obj1 = testPrivetAndPublic('mohammed', 30, '123456')
# # # print(Obj1)
# # # print(Obj1.setPassword('123456789'))
...
# # # obj2 = Products('milk', 10, 0.2, '1/1/2024')

# # # print(obj2)


# # obj2 = Father('ali', 50)
# # obj1 = Son('mohammed', 30)
# # print(obj1.talk())
# # # class Student:
...
# # #             for i in students:
# # #                 if i.name==username and i.password==password1:
...
#         self.fatherage = age
#     def talk(self):
#         return f'hello my name is {self.father}'
#     def __str__(self):
#         return f'name is {self.name} and age is {self.age}'
...
#     def __str__(self):
#         return f'name is {self.name} and age is {self.age} , father name is {self.father} and father age is {self.fatherage} '
